    ...
    <div className="relative w-full h-dvh overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-4">
        <div className="backdrop-blur-xl bg-white/5 rounded-3xl px-10 py-12 max-w-lg w-full text-center border border-white/20 shadow-2xl">
          ...
          <button
            className="inline-flex items-center gap-3 px-12 py-6 rounded-full bg-white/15 hover:bg-white/25 border border-white/25 text-white font-semibold text-xl backdrop-blur-sm transition-all duration-200 cursor-pointer"
